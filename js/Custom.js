            ...
            $('#reindeer').animate({
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                        "<<< Merry Christmas >>>",
                        "Hôm nay ông già Noel không thể đi tặng quà cho mọi người vì đàn tuần lộc của ông đã chạy mất. Có 10 con chạy đi nhưng chỉ tìm lại được 9 con, còn 1 con đang ngồi đọc tin nhắn này! Hì Hì... Chúc em có 1 giáng sinh an lành và hong có lạnh nha cô bé Thương!!",
                        ],
                        typeSpeed: 250,
                        startDelay: 500,
                        backSpeed: 50,
